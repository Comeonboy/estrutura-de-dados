...
class Noh():
    def __init__(self, valor, esquerdo=None, direito=None): #OK
...
class Lista():
    ...
    def adicionar_a_esquerda(self, valor): #OK
        if self.tam == 0:
            noh = Noh(valor)
            self.primeiro = noh
            self.ultimo = noh
            ...
            noh = self.primeiro
            noh1 = Noh(valor, None, noh)
            noh.esquerdo = noh1
            self.primeiro = noh1            
        self.tam +=1

    def remover(self): #quase OK
        if self.tam == 0:
            erro = ListaVaziaErro("erro")
            raise erro
        else:
            excluido = self.ultimo.valor
            if self.tam == 1:
                self.primeiro = None
                self.ultimo = None
            else:
    ...
    def remover_a_esquerda(self): #quase OK
        if self.tam == 0:
            erro = ListaVaziaErro("erro")
            raise erro
        else:
            excluido = self.primeiro.valor
            if self.tam == 1:
                self.primeiro = None
                self.ultimo = None
            else:
...
class NohTestes(unittest.TestCase):
    ...
    def test_init_com_no_direito(self): #OK
        direito = Noh(1)
        noh = Noh(2, direito=direito)
        self.assertEqual(direito, noh.direito)
        self.assertIsNone(noh.esquerdo)

    def test_init_com_no_esquerdo_e_direito(self):#OK
        esquerdo = Noh(1)
        direito = Noh(2)
...
class ListaTestes(unittest.TestCase): 
    ...
    def test_adicionar_primeiro(self): #OK
        lista = Lista()
        lista.adicionar(0)
    ...
    def test_adicionar_segundo(self): #OK
        lista = Lista()
        lista.adicionar(0)
        lista.adicionar(1)
    ...
    def test_adicionar_terceiro(self): #OK
        lista = Lista()
        lista.adicionar(0)
        lista.adicionar(1)
        lista.adicionar(2)
    ...
    def test_adicionar_primeiro_a_esquerda(self): #OK
        lista = Lista()
    ...
    def test_adicionar_segundo_a_esquerda(self): #OK
        lista = Lista()
        lista.adicionar_a_esquerda(0)
    ...
    def test_remover_lista_1_elemento(self): #OK
        lista = Lista()
        lista.adicionar(0)
    ...
    def test_remover_lista_2_elementos(self): #OK
        lista = Lista()
        lista.adicionar(0)
        lista.adicionar(1)
    ...
    def test_remover_lista_3_elementos(self): #OK
        lista = Lista()
        lista.adicionar(0)
        lista.adicionar(1)
        lista.adicionar(2)
    ...
    def test_remover_a_esquerda_lista_1_elemento(self): #OK
        lista = Lista()
        lista.adicionar(0)
    ...
    def test_remover_a_esquerda_lista_2_elementos(self): #OK
        lista = Lista()
        lista.adicionar(0)
        lista.adicionar(1)
        self.assertEqual(0, lista.remover_a_esquerda())
    ...
    def test_remover_a_esquerda_lista_3_elementos(self): #OK
        lista = Lista()
        lista.adicionar(0)
        lista.adicionar(1)
        lista.adicionar(2)
